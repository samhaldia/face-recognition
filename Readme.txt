...
To Get API Endpoints and API Key Follow below URLs to Register and fetch key:
...
Requiste Libraries:
 ...
 Create embedding data to a dictionary and then serialize the data  in a pickle file 
